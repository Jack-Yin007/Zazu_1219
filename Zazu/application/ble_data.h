...
#define BLE_DATA_SEND_TIMER_PERIOD_MS (10)

#define BLE_DATA_SEND_BUFFER_CELL_NUM (80)
#define BLE_DATA_SEND_BUFFER_CELL_LEN (244)

#define BLE_DATA_RECV_BUFFER_CELL_NUM (80)
#define BLE_DATA_RECV_BUFFER_CELL_LEN (244)
...
extern int8_t ble_send_data_pop(uint8_t **p_data, uint16_t *p_len, uint16_t *p_ch);
extern void ble_send_data_delete_one(void);
...
extern uint32_t ble_aus_white_list_set(void);
extern void ble_aus_set_adv_filter(uint8_t *p_addr);
