...
#define CHG_TEMP_LIMIT5     70     // when battery lower 7.4v,we should adjust temp to 70C
//#define CHG_TEMP_LIMIT4		50 		//

#define CHG_CUR_LIMIT0		0 		// Charging current limit. Unit in mA
#define CHG_CUR_LIMIT400    400
#define CHG_CUR_LIMIT600    600
#define CHG_CUR_LIMIT1000   1000
